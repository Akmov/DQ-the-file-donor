...
Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Mʏ Cᴏᴍᴍᴀɴᴅs.</b>"""
    ...
    ABOUT_TXT = """<b>✯ Mʏ Nᴀᴍᴇ: {}
✯ Cʀᴇᴀᴛᴏʀ: <a href='https://t.me/SM_DVDUPDATES>Jᴏᴇʟ Kᴜʀɪᴀɴ Bɪᴊᴜ</a>
...
- ꜱᴏᴜʀᴄᴇ - <a href="https://github.com/Akmov/DQ-The-File-Donor">ʜᴇʀᴇ</a>
Dᴇᴠᴇʟᴏᴘᴇʀ:
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/SM_DVDUPDATES)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
=========== • ✠ • ===========
▫️ ᴄʜᴀɴɴᴇʟ : @SM_DVDUPDATES 
▫️ sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ : @Spyrogroups 
=========== • ✠ • ===========</b>"""
